...
exports.Class5QueuesApi = exports.Class5QueuesApiApiKeys = void 0;
...
// ===============================================
var Class5QueuesApiApiKeys;
(function (Class5QueuesApiApiKeys) {
    Class5QueuesApiApiKeys[Class5QueuesApiApiKeys["instanceId"] = 0] = "instanceId";
    Class5QueuesApiApiKeys[Class5QueuesApiApiKeys["token"] = 1] = "token";
})(Class5QueuesApiApiKeys = exports.Class5QueuesApiApiKeys || (exports.Class5QueuesApiApiKeys = {}));
var Class5QueuesApi = /** @class */ (function () {
    function Class5QueuesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(Class5QueuesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(Class5QueuesApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(Class5QueuesApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    Class5QueuesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    Class5QueuesApi.prototype.setApiKey = function (key, value) {
        this.authentications[Class5QueuesApiApiKeys[key]].apiKey = value;
    };
    Class5QueuesApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    Class5QueuesApi.prototype.clearActionsQueue = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_1, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/clearActionsQueue';
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "ClearActionsQueueStatus");
     ...
     */
    Class5QueuesApi.prototype.clearMessagesQueue = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_2, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/clearMessagesQueue';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "ClearMessagesQueueStatus");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
     ...
     */
    Class5QueuesApi.prototype.showActionsQueue = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, produces, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise, interceptorPromise, _loop_3, _i, _a, interceptor;
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/showActionsQueue';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "OutboundActions");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
     ...
     * @summary Get outbound messages queue.
     */
    Class5QueuesApi.prototype.showMessagesQueue = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/showMessagesQueue';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                        ...
                        return new Promise(function (resolve, reject) {
                            request_1.default(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "OutboundMessages");
                                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                        resolve({ response: response, body: body });
                                    }
                                    else {
    ...
    return Class5QueuesApi;
}());
exports.Class5QueuesApi = Class5QueuesApi;
