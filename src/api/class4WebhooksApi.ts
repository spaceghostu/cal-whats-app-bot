...
export enum Class4WebhooksApiApiKeys {
    instanceId,
    token,
}

export class Class4WebhooksApi {
    ...
    public setApiKey(key: Class4WebhooksApiApiKeys, value: string) {
        (this.authentications as any)[Class4WebhooksApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param webhookUrl 
     */
    public async setWebhook (webhookUrl: WebhookUrl, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SetWebhookStatus;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(webhookUrl, "WebhookUrl")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SetWebhookStatus;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "SetWebhookStatus");
